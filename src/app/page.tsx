  ...
  return (
    ...
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
      ...
      <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
        PagePal allows you to have conversation with any PDF document. 
      ...
      <div>
        <div className="relative isolate">
          ...
          <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
            ...
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-36rem)] sm:w-[72.1875rem]"></div>
          </div>
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                Either starting out or with a free plan or a choose our{' '} 
                <Link className="text-blue-700 underline underline-offset-2" href="/pricing" target="_blank">pro plan</Link>.
              </span>
            </div>
          </li>
